...
public:
    ...
    XBasicAtomic() = default;
    explicit constexpr XBasicAtomic(T const & value ) noexcept : m_x_value(value) {}
...
public:
    ...
    XBasicAtomicInteger() = default;
    constexpr XBasicAtomicInteger(T const & value) noexcept : Base_(value) {}
